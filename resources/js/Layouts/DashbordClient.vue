...
const navItems = [
  ...
  },
  {
    route: 'client.fleet',
    label: 'Fleet',
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 13h2l3-8h8l3 8h2"/><path d="M5 13v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"/><path d="M16 13V9a4 4 0 0 0-8 0v4"/></svg>`,
  },
